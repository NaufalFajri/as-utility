...
print("name your costume")
costume_name = input("Enter costume name: ")
print("input whatever you want")
costume_dictionary = input("Enter costume dictionary: ")
thumbnail_costume_path = input("Enter thumbnail costume path: ")
costume_path = input("Enter costume path: ")
...
# Construct the dictionary_masterdata
...
# Connect to dictionary.db and perform INSERT
...
# Connect to asset.db and perform INSERTs
