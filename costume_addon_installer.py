...
encrypted_costume = "encrypted_data/2d61e7b4e89961c7/0_" + os.path.splitext(costume_file.split("/")[-1])[0]
encrypted_thumbnail = "encrypted_data/2d61e7b4e89961c7/0_" + os.path.splitext(thumbnail_file.split("/")[-1])[0]
...
if chara_id == 209:
    encrypted_rina_unmask = "encrypted_data/2d61e7b4e89961c7/0_" + os.path.splitext(rina_unmask_costume_file.split("/")[-1])[0]

# encrypting asset first
encrypted_folder = "encrypted_data/2d61e7b4e89961c7/"
...
with sqlite3.connect('assets/db/gl/asset_a_en.db') as conn:
    ...
    get_main_asset_a_en = cursor.fetchone()[0]
    update_main_asset_a_en = get_main_asset_a_en + 1
    if chara_id == "209":
        ...
        cursor.execute("INSERT INTO main.m_asset_package (package_key, version, pack_num) VALUES (?, ?, '2');", (package_key_costume, empty_string_cdn))
    else:
        cursor.execute("INSERT INTO main.m_asset_package_mapping (package_key, pack_name, file_size, metapack_name, metapack_offset, category) VALUES (?, ?, ?, ?, '0', ?);", (package_key_costume, costume_filename, costume_filesize, donot_insert, category_costume))
        cursor.execute("INSERT INTO main.m_asset_package (package_key, version, pack_num) VALUES (?, ?, '1');", (package_key_costume, empty_string_cdn))
    ...
    cursor.execute("REPLACE INTO main.m_asset_package (package_key, version, pack_num) VALUES ('main', ?, ?);", (empty_string_cdn, update_main_asset_a_en))
    cursor.execute("UPDATE m_asset_package SET version = ?", (empty_string_cdn,))
...
if os.path.exists(file_path_trade_stuff):
    ...
    shutil.rmtree(temp_directory, ignore_errors=True)
    print("FINISHED")
    print("WARNING! ADDING ASSET TO CDN IS NOT COMPLETED, IT MAY LOSE FILE ON NEXT DOWNLOAD")
    sys.exit(1)
